...
(def web-view
  (lifecycle.composite/describe WebView
    ...
    :props {:context-menu-enabled [:setter prop/scalar :default true]
            :font-scale [:setter prop/scalar :coerce coerce/as-double :default 1.0]
            ...
            :pref-height [:setter prop/scalar :coerce coerce/as-double :default 600.0]
            :pref-width [:setter prop/scalar :coerce coerce/as-double :default 800.0]
            :zoom [:setter prop/scalar :coerce coerce/as-double :default 1.0]
