...
(def keyword->lifecycle-delay
  {;; cameras
   ...
   :distant-light (lazy-load cljfx.fx.distant-light/lifecycle)
   :point-light-effect (lazy-load cljfx.fx.point-light-effect/lifecycle)
   :spot-light (lazy-load cljfx.fx.spot-light/lifecycle)
